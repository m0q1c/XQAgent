...
name_zh: "AI文本人性化改写"
name_ja: "AIテキスト人間化"
description: "Rewrite AI-generated text to pass AI detection tools. Invoke when users need ChatGPT/Claude/GPT output rewritten into natural human-style text to pass GPTZero, Turnitin, Originality.ai, and similar detectors."
description_zh: "将 AI 生成的文本人性化改写，使其自然流畅并通过 AI 检测工具的识别。"
description_ja: "AI生成テキストをAI検出ツールが通過できるよう人間らしい文体に書き換える。ChatGPT・Claude等の出力をGPTZero・Turnitin等の検出を回避できる自然な文章に変換。"
allowed-tools:
  - Read
  - Write
  - StrReplace
