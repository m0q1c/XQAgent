...
name_zh: "Markdown 转换器"
description_zh: "使用 markitdown 将 PDF、Word、PowerPoint 等文档转换为 Markdown 格式。"
name_ja: "Markdownコンバーター"
description_ja: "markitdownを使用してPDF・Word・PowerPointなどのドキュメントをMarkdown形式に変換する。"
---
